...
Compared to other sandboxed container runtimes, e.g., kata\cite*{Kata-Containers} and gvisor\cite*{gvisor}, Quark eliminates unnecessary code by using the Qkernel as the guest operating system, 
resulting in a smaller memory footprint, a shorter boot time, less overhead, and ensuring the same level of isolation and security for containers\cite*{quark_performance_report}.



\subsection{How HCALL work}
\subsection{How UCALL work}
