...
This section gives a high-level overview of the Quark container by introducing its main components and explaining how the guest (Qkenel) communicates with the 
VMM (Qvisor) and Host kernels using Hcall and Ucall, respectively. This explanation is necessary for a better understanding of Chapter 4.
